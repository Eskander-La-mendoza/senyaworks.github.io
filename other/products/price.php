...
<body>
    ...
    <main>
        <h1 class="price-list-header">PRICE-лист</h1>
        <br>
        <br>
        <table class="price-table">
        <th class="price-table-th">Наименование</th>
        <th>Цена</th>
        <?php foreach ($goods as $item) : ?>  
            <tr>
                <td class="price-table-td"><p id="item_name"><?= $item['item_name']; ?></p></td>
                <td class="price-table-td"><p id="price"><?= $item['price']; ?> ₸</p></td>
            </tr>
        <?php endforeach; ?>
        </table>
        <br>
