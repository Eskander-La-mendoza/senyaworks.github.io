...
<body>
    ...
    <div class="row">
    <div class="card">
        <p><button class="card_button"><a href="parts/cpus.php"><img src="../../imgs/parts catalogue/cpu-illustration-2048x1223-oowgjeka.png" alt="Серверы" style="width:100%"><h1>Процессоры</h1></a></button></p>
    </div>
    <div class="card">
        <p><button class="card_button"><a href="parts/ram.php"><img src="../../imgs/parts catalogue/ram.png" alt="Комплектующие" style="width:100%"><h1>ОЗУ</h1></a></button></p>
    </div>
    <div class="card">
        <p><button class="card_button"><a href="parts/gpus.php"><img src="../../imgs/parts catalogue/gpu.png" alt="ИБП" style="width:100%"><h1>Видеокарты/Графические адаптеры</h1></a></button></p>
    </div>
    </div>
    <div class="row">
    <div class="card">
        <p><button class="card_button"><a href="parts/mbs.php"><img src="../../imgs/parts catalogue/mb.png" alt="СХД" style="width:100%"><h1>Материнские платы</h1></a></button></p>
    </div>
    <div class="card">
        <p><button class="card_button"><a href="parts/cases.php"><img src="../../imgs/parts catalogue/case.png" alt="Биометрия" style="width:100%"><h1>Корпусы</h1></a></button></p>
    </div>
    <div class="card">
        <p><button class="card_button"><a href="parts/drives.php"><img src="../../imgs/parts catalogue/hdd.png" alt="Коммутаторы" style="width:100%"><h1>Хранилище</h1></a></button></p>
    </div>
    </div>
    </main>
