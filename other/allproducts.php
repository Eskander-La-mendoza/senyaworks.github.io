...
<body>
    ...
    <div class="row">
    <div class="card">
        <p><button class="card_button"><a href="products/servers.php"><img src="../imgs/20240103160158irajmr.jpg" alt="Серверы" style="width:100%"><h1>Серверы</h1></a></button></p>
    </div>
    <div class="card">
        <p><button class="card_button"><a href="products/parts.php"><img src="../imgs/server-support-repair-service-maintenance-hardware-buy-part-sell-bee-1408-28-bee@13-600x600.jpg" alt="Комплектующие" style="width:100%"><h1>Комплектующие к серверам</h1></a></button></p>
    </div>
    <div class="card">
        <p><button class="card_button"><a href="products/ups.php"><img src="../imgs/источник-бесперебойного-питания-600x451.jpg" alt="ИБП" style="width:100%"><h1>Источники бесперебойного питания</h1></a></button></p>
    </div>
    </div>
    <div class="row">
    <div class="card">
        <p><button class="card_button"><a href="products/storage.php"><img src="../imgs/16907-Infotrend-Eonstor-DS-G7i-16G.jpg" alt="СХД" style="width:100%"><h1>Системы хранения данных</h1></a></button></p>
    </div>
    <div class="card">
        <p><button class="card_button"><a href="products/biometrics.php"><img src="../imgs/cybersecurity_finger.jpeg" alt="Биометрия" style="width:100%"><h1>Биометрия</h1></a></button></p>
    </div>
    <div class="card">
        <p><button class="card_button"><a href="products/network.php"><img src="../imgs/unnamed.jpg" alt="Коммутаторы" style="width:100%"><h1>Коммутаторы</h1></a></button></p>
    </div>
    </div>
    </main>
