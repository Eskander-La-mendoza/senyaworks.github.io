...
<body>
    ...
    <main>
        <div class="row">
            <div class="card">
                <p><button class="card_button"><a href="services/repair.php"><img src="../imgs/xwja4xb3ig9a1(1).jpg" alt="Серверы" style="width:100%"><h1>Ремонт и сервисное обслуживание серверов</h1></a></button></p>
            </div>
            <div class="card">
                <p><button class="card_button"><a href="services/leasing.php"><img src="../imgs/1491575850_servrent_01.jpg" alt="Комплектующие" style="width:100%"><h1>Аренда серверов и лизинг серверов</h1></a></button></p>
            </div>
        </div>
    </main>
